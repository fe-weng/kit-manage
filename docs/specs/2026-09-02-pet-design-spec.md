...
> **核心感受**：「好可爱！我想养它！」
>
> **后续功能**：多宠物养成已实施，见 [多宠物养成设计规范](./2026-09-14-multi-pet-design-spec.md)
...
ChatGPT 出图 Prompt（每阶段 4 表情、含角色锁定与文件名）：[2026-09-14-pet-expression-prompts.md](./2026-09-14-pet-expression-prompts.md)
...
- 保持同一阶段的一致性
- 过渡要自然（可用 2-3 帧渐变）
- 现有阶段主图当作「普通」；新出开心 / 难过 / 饥饿。蛋不要画五官，用裂纹和光表达情绪
